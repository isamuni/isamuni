...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PageSelector_vue__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e5537b3a_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_PageSelector_vue__ = __webpack_require__(28);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_PageSelector_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e5537b3a_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_PageSelector_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "app/javascript/packs/PageSelector.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e5537b3a", Component.options)
  } else {
    hotAPI.reload("data-v-e5537b3a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect_dist_vue_multiselect_min_css__ = __webpack_require__(27);
...
/* harmony default export */ __webpack_exports__["a"] = (PageSelector);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-e5537b3a", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Feed_vue__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PageSelector_vue__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__UserFeed_vue__ = __webpack_require__(29);
/* eslint no-console:0 */
...
*/
var dataOnly = function dataOnly(r) {
    return r;
};
...
window.DataSource = {
    ...
    getPosts: function getPosts(filter) {
        var rawPosts = $.getJSON('/feed/posts.json', filter).then(dataOnly);
        var enrichedResults = $.when(this.getSources(), rawPosts).then(function (sources, posts) {
            posts.forEach(function (post) {
                post['source'] = sources.find(function (s) {
                    return s.id == post['source_id'];
                }) || {};
            });
            return posts;
        });
...
window.App = {
    Feed: __WEBPACK_IMPORTED_MODULE_1__Feed_vue__["default"],
    PageSelector: __WEBPACK_IMPORTED_MODULE_2__PageSelector_vue__["default"],
    UserFeed: __WEBPACK_IMPORTED_MODULE_3__UserFeed_vue__["default"]
};
